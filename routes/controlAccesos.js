...
router.post("/", async (req, res) => {
    ...
    const nDate = new Date().toLocaleString('en-US', { timeZone: 'America/Mexico_City' });
    let hora = nDate.split(", ")[1];
    const fecha = new Date(nDate).toLocaleDateString('en-US', { month: '2-digit', day: '2-digit', year: 'numeric' });
    console.log(hora);
    console.log(fecha);
